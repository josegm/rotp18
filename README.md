...
```ruby
totp = ROTP::TOTP.new("base32secret3232", issuer: "My Service", name: "alice@google.com")
totp.provisioning_uri() # => 'otpauth://totp/My%20Service:alice@google.com?secret=base32secret3232&issuer=My+Service'

hotp = ROTP::HOTP.new("base32secret3232", issuer: "My Service", name: "alice@google.com")
hotp.provisioning_uri() # => 'otpauth://hotp/My%20Service:alice@google.com?secret=base32secret3232&counter=0'
```
